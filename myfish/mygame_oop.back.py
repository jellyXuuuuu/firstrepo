...
#         pass
    ...
    #     global f1, f2, f3, f4
    #     print("123456")
    #     while i_flag == 2 or i_flag == 3 or i_flag == 4:
    #         #     print("enemy looooop")
    #         # if at round one, which means only ocean fish from left to right
    #         if not round_one and not round_two and not round_three and flag == 0:
    #             x_enemy1 = rand(200,800)
    #             y_enemy1 = rand(10,320)
    #             x_enemy2 = rand(0,600)
    #             y_enemy2 = rand(10,300)
    ...
    #             # self.ocean_fish_move(1)
    #             print("enemyfish-1")
    #         # elif count2 >= 1 and count1 >= 10:
    #         if round_one and not round_two and not round_three and flag == 0:
    #             # global x3, x4, f3, f4
    ...
    #             # self.ocean_fish_move(2)
    #             print("enemyfish-2")
    #         # elif count3 >= 10 and count4 >= 1:
    #         if round_one and not round_two and not round_three and flag == 1:
    #             fish_enemy3.blank()
    #             fish_enemy4.blank()
    #             # f8, f9, f10 & f 11 are for round three ocean fish
    #             f8 = self.canvas.create_image(0,100,image = fish8)
    ...
    #         # elif count5 >= 10 and count6 >=1 and count7 >= 10 and count8 >= 1 and round_three == 0:
    #         if round_one and not round_two and not round_three and flag == 2:
    #             fish_enemy5.blank()
    #             fish_enemy6.blank()
    #             fish_enemy7.blank()
    #             fish_enemy8.blank()
